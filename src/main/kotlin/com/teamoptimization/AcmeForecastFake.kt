...
class AcmeForecastFake : BaseClient {
    ...
    private var possibleWeatherMap: Map<String, List<AcmeForecastingClientResult>> = mutableMapOf()

    init {
        (possibleWeatherMap as MutableMap<String, List<AcmeForecastingClientResult>>)["Oxford"] = mutableListOf(
        ...
        (possibleWeatherMap as MutableMap<String, List<AcmeForecastingClientResult>>)["London"] = mutableListOf(
